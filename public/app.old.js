...
// ========================================
// GESTIÓN DE CURSOS - PÁGINA DEDICADA
// ========================================
...
function renderCursosTable(cursos) {
    ...
    tbody.innerHTML = cursos.map(curso => `
        <tr>
            ...
            <td></td>
            <td>
                <span class=\"badge-info\"> alumnos</span>
            </td>
            <td>
                <div class=\"action-buttons-inline\">
                    <button class=\"btn-sm btn-edit\" onclick=\"editarCurso()\" title=\"Editar\">
                        ✏️
                    </button>
                    <button class=\"btn-sm btn-delete\" onclick=\"eliminarCurso(, '')\" title=\"Eliminar\">
                        🗑️
                    </button>
                </div>
            </td>
